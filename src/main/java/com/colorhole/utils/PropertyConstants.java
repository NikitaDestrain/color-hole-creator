...
public class PropertyConstants {
    public static String PATH_TO_RUN_PROPERTY = "properties/";
    ...
    public static final String MIN_WIDTH_PROPERTY = "min_width";
    public static final String MAX_WIDTH_PROPERTY = "max_width";
